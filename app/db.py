...
SQLITE_ADDITIVE_MIGRATIONS = {
    "discordmessage": {
        ...
        "last_parse_input_fingerprint": "TEXT",
        "last_successful_parse_status": "TEXT",
    ...
    TIKTOK_ORDERS_TABLE: {
        ...
        "order_status": "TEXT",
        "currency": "TEXT",
        "affiliate_creator_username": "TEXT",
        "affiliate_content_type": "TEXT",
        "affiliate_content_id": "TEXT",
        "affiliate_attribution_json": "TEXT DEFAULT '{}'",
        "line_items_json": "TEXT DEFAULT '[]'",
        "line_items_summary_json": "TEXT DEFAULT '[]'",
        "raw_payload": "TEXT DEFAULT '{}'",
        "source": "TEXT DEFAULT 'webhook'",
    ...
    "employeeprofile": {
        ...
        "discord_linked_by_user_id": "INTEGER",
    },
    "inventory_items": {
        "variant": "TEXT",
    ...
    "gmail_receipts": {
        ...
        "received_at": "TIMESTAMP",
        "detected_vendor": "TEXT DEFAULT ''",
        "detected_type": "TEXT DEFAULT 'receipt'",
        "total_amount": "REAL",
        "tender": "TEXT",
    ...
    "gmail_receipt_line_items": {
        "gmail_receipt_id": "INTEGER",
        "row_index": "INTEGER",
        "name": "TEXT",
        "set_name": "TEXT",
        "card_number": "TEXT",
...
SQLITE_INDEX_MIGRATIONS = [
    ...
    "CREATE UNIQUE INDEX IF NOT EXISTS ix_tiktok_creator_auth_creator_username ON tiktok_creator_auth (creator_username)",
    "CREATE INDEX IF NOT EXISTS ix_tiktok_creator_auth_open_id ON tiktok_creator_auth (open_id)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_gmail_receipts_detected_vendor ON gmail_receipts (detected_vendor)",
    "CREATE INDEX IF NOT EXISTS idx_gmail_receipt_line_items_receipt_id ON gmail_receipt_line_items (gmail_receipt_id)",
    "CREATE INDEX IF NOT EXISTS idx_gmail_evidence_links_receipt_id ON gmail_evidence_links (gmail_receipt_id)",
    "CREATE INDEX IF NOT EXISTS idx_gmail_evidence_links_bank_transaction_id ON gmail_evidence_links (bank_transaction_id)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_tiktok_orders_affiliate_creator_username ON tiktok_orders (affiliate_creator_username)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_orders_affiliate_content_type ON tiktok_orders (affiliate_content_type)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_orders_affiliate_content_id ON tiktok_orders (affiliate_content_id)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_display_name ON tiktok_creator_auth (display_name)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_app_key ON tiktok_creator_auth (app_key)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_access_token_expires_at ON tiktok_creator_auth (access_token_expires_at)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_refresh_token_expires_at ON tiktok_creator_auth (refresh_token_expires_at)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_source ON tiktok_creator_auth (source)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_received_at ON tiktok_creator_auth (received_at)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_created_at ON tiktok_creator_auth (created_at)",
    "CREATE INDEX IF NOT EXISTS idx_tiktok_creator_auth_updated_at ON tiktok_creator_auth (updated_at)",
    ...
    "CREATE UNIQUE INDEX IF NOT EXISTS idx_employeeprofile_discord_user_id ON employeeprofile (discord_user_id)",
    "CREATE INDEX IF NOT EXISTS idx_employeeprofile_discord_username ON employeeprofile (discord_username)",
    "CREATE INDEX IF NOT EXISTS idx_employeeprofile_discord_linked_at ON employeeprofile (discord_linked_at)",
    "CREATE INDEX IF NOT EXISTS idx_employeeprofile_discord_linked_by_user_id ON employeeprofile (discord_linked_by_user_id)",
