...
class Settings(BaseSettings):
    ...
    password_reset_email_provider: str = Field(default="dry_run", alias="PASSWORD_RESET_EMAIL_PROVIDER")
    password_reset_email_from: str = Field(default="", alias="PASSWORD_RESET_EMAIL_FROM")
    password_reset_email_from_name: str = Field(default="Degen Team", alias="PASSWORD_RESET_EMAIL_FROM_NAME")
    password_reset_smtp_host: str = Field(default="", alias="PASSWORD_RESET_SMTP_HOST")
    password_reset_smtp_port: int = Field(default=587, alias="PASSWORD_RESET_SMTP_PORT")
    password_reset_smtp_username: str = Field(default="", alias="PASSWORD_RESET_SMTP_USERNAME")
    password_reset_smtp_password: str = Field(default="", alias="PASSWORD_RESET_SMTP_PASSWORD")
