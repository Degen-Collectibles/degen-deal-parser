...
from app.finance.plaid_bank_feed import sync_plaid_connection
...
def test_plaid_sync_runs_ledger_agent_after_successful_sync(monkeypatch):
    ...
    monkeypatch.setattr("app.finance.plaid_bank_feed.decrypt_access_token", lambda _blob: "access-token")
    monkeypatch.setattr("app.finance.plaid_bank_feed._plaid_post", fake_plaid_post)
