...
def test_local_gate_plan_contains_expected_read_only_steps():
    ...
    assert "tests/test_degen_ops_prompt_coverage.py" in plan["tests"]
    assert "tests/test_degen_ops_deploy_preflight.py" in plan["tests"]
    assert "tests/test_degen_ops_discord_auth.py" in plan["tests"]
    assert "tests/test_admin_employee_list_search.py" in plan["tests"]
    assert "tests/test_wave47_admin_tools.py" in plan["tests"]
    assert "scripts/degen_ops_prompt_coverage.py" in plan["compile"]
    assert "scripts/degen_ops_deploy_preflight.py" in plan["compile"]
